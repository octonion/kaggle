...
drop table if exists march_madness.m_schedule_factors;

create table march_madness.m_schedule_factors (
        team_id                 integer,
        season                  integer,
        offensive               float,
        defensive               float,
...
update march_madness.m_schedule_factors
...
strength=o.strength
from march_madness.m_schedule_factors o
...
from march_madness.m_factors f
...
from rs
where
  (m_schedule_factors.team_id,m_schedule_factors.season)=
